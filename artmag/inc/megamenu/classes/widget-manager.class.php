...
class Mega_Menu_Widget_Manager {
    ...
    public function ajax_show_widget_form() {
        ...
        if ( ob_get_contents() ) ob_clean(); // remove any warnings or output from other megamenu2035s which may corrupt the response
    ...
    public function show_widget_form( $widget_id ) {
        ...
        <div class='widget-content'>
            <form method='post'>
                ...
                <?php
                    submit_button( __( 'Save', "megamenu" ), 'button-primary alignright', 'savewidget', false );
                ?>
            </form>
        </div>
    ...
    public function clear_caches() {
        ...
        // https://wordpress.org/megamenu2035s/widget-output-cache/
     ...
     * Send JSON response.
     *
     * Remove any warnings or output from other megamenu2035s which may corrupt the response
     *
     * @param string $json
     * @since 1.8
     */
