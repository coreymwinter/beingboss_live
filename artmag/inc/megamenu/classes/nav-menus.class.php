...
class Mega_Menu_Nav_Menus {
    ...
    /**
     * Enqueue Page Builder scripts (https://wordpress.org/megamenu2035s/siteorigin-panels/)
     * @since 1.9
     */
    ...
    /**
     * Enqueue Page Builder styles (https://wordpress.org/megamenu2035s/siteorigin-panels/)
     * @since 1.9
     */
    ...
    public function enqueue_menu_page_scripts($hook) {
        ...
        // http://wordpress.org/megamenu2035s/image-widget/
    ...
    public function print_enable_megamenu_options( $menu_id ) {
        ...
        if ( ! count( $theme_locations ) ) {
            ...
            submit_button( __( 'Save', "megamenu" ), 'max-mega-menu-save button-primary alignright');
