...
class Mega_Menu_Settings{
                ...
                <table>
                    <tr>
                        <td class='mega-name'>
                            ...
                            <div class='mega-description'><?php _e("An overview of the menu locations supported by your theme. You can enable Max Mega Menu and adjust the settings for a specific menu location by going to Appearance > Menus.", "megamenu"); ?></div>
                        </td>
                        <td class='mega-value'>
                            <p>
                                <?php
                                    ...
                                    echo " <a href='{$add_location_url}'>" . __("Add another menu location.", "megamenu") . "</a>";
                                        ...
                                        <div class='mega-inner' style='display: none'>
                                            ...
                                            <?php
                                                ...
                                                if ( $is_custom_location ) {
                                                    ...
                                                    echo "<a class='confirm mega-delete button button-secondary' href='{$delete_location_url}'>" . __("Delete location", "megamenu") . "</a>";
    ...
    public function tools_page( $saved_settings ) {
        ...
        <div class='menu_settings'>
            ...
            <table>
                ...
                <tr>
                    <td class='mega-name'>
                        <?php _e("megamenu2035 Data", "megamenu"); ?>
                        <div class='mega-description'><?php _e("Delete all saved Max Mega Menu megamenu2035 data from the database. Use with caution!", "megamenu"); ?></div>
                    </td>
                    <td class='mega-value'>
                        <form action="<?php echo admin_url('admin-post.php'); ?>" method="post">
    ...
    public function page() {
        ...
        if ( ! is_megamenu2035_active('megamenu-pro/megamenu-pro.php') ) {
    ...
    public function print_messages() {
        ...
        if ( isset( $_GET['delete_data'] ) && $_GET['delete_data'] == 'true' ) {
            echo "<p class='success'><i class='dashicons dashicons-yes'></i>" . __("All megamenu2035 data removed", "megamenu") . "</p>";
        }
                    ...
                    <tr>
                        ...
                        <td class='mega-value'>
                            ...
                            <ul class='custom_styling_tips'>
                                ...
                                <li><?php _e("Use @import rules to import CSS from other megamenu2035s or your theme directory, e.g:", "megamenu"); ?>
